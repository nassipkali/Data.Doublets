namespace Platform::Data::Doublets {
  class UInt64LinksExtensions {
   ...
   public:
    static std::string FormatStructure(ILinks<std::uint64_t> &storage, std::uint64_t linkIndex, Func<Link<std::uint64_t>, bool> isElement, bool renderIndex = false, bool renderDebug = false) {
      std::string sb;
   ...
   public:
    static std::string FormatStructure(ILinks<std::uint64_t> &storage, std::uint64_t linkIndex, Func<Link<std::uint64_t>, bool> isElement, Action<StringBuilder, Link<std::uint64_t>> appendElement, bool renderIndex = false, bool renderDebug = false) {
      std::string sb;
      auto visited = HashSet<std::uint64_t>();
   ...
   public:
    static void AppendStructure(ILinks<std::uint64_t> &storage, std::string &sb, HashSet<std::uint64_t> visited, std::uint64_t linkIndex, Func<Link<std::uint64_t>, bool> isElement, Action<StringBuilder, Link<std::uint64_t>> appendElement, bool renderIndex = false, bool renderDebug = false) {
      if (sb == nullptr) {
