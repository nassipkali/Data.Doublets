namespace Platform::Data::Doublets::Memory::Split::Generic {
  template <typename TSelf, typename TLinksOptions, typename TMemory, typename TInternalSourcesTreeMethods, typename TInternalLinksSourcesLinkedListMethods, typename TInternalTargetsTreeMethods, typename TExternalSourcesTreeMethods, typename TExternalTargetsTreeMethods, typename TUnusedLinksListMethods, typename... TBase>
