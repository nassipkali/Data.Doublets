namespace Platform::Data::Doublets::Memory::Split::Generic {
  ...
  class InternalLinksSourcesSizeBalancedTreeMethods : public InternalLinksSizeBalancedTreeMethodsBase<InternalLinksSourcesSizeBalancedTreeMethods<TLinksOptions>, TLinksOptions> {
   ...
   public:
    InternalLinksSourcesSizeBalancedTreeMethods(std::byte* linksDataParts, std::byte* linksIndexParts, std::byte* header) : base(linksDataParts, linksIndexParts, header) {}
   ...
   public:
    LinkAddressType GetTreeRoot(LinkAddressType link) {
      return this->GetLinkIndexPartReference(link).RootAsSource;
    }
