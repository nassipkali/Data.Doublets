namespace Platform::Data::Doublets::Memory::Split::Generic {
  ...
  class InternalLinksTargetsRecursionlessSizeBalancedTreeMethods : public InternalLinksRecursionlessSizeBalancedTreeMethodsBase<InternalLinksTargetsRecursionlessSizeBalancedTreeMethods<TLinksOptions>, TLinksOptions> {
   ...
   public:
    InternalLinksTargetsRecursionlessSizeBalancedTreeMethods(std::byte* linksDataParts, std::byte* linksIndexParts, std::byte* header) : base(linksDataParts, linksIndexParts, header) {}
   ...
   public:
    LinkAddressType Search(LinkAddressType source, LinkAddressType target) { return this->SearchCore(this->GetTreeRoot(target), source); }
  };
}  // namespace Platform::Data::Doublets::Memory::Split::Generic
