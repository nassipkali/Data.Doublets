namespace Platform::Data::Doublets::Memory::United::Generic {
  ...
  template <typename TSelf, typename TLinkOptions, typename TMemory, typename TSourceTreeMethods, typename TTargetTreeMethods, typename TUnusedLinks, typename... TBase>
