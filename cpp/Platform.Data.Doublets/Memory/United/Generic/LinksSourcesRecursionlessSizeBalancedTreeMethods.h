namespace Platform::Data::Doublets::Memory::United::Generic {
  ...
  struct LinksSourcesRecursionlessSizeBalancedTreeMethods : public LinksRecursionlessSizeBalancedTreeMethodsBase<LinksSourcesRecursionlessSizeBalancedTreeMethods<TLinksOptions>, TLinksOptions> {
   ...
   public:
    LinkAddressType GetSize(LinkAddressType node) {
      return this->GetLinkReference(node).SizeAsSource;
    }

   public:
    void SetSize(LinkAddressType node, LinkAddressType size) {
      this->GetLinkReference(node).SizeAsSource = size;
    }
