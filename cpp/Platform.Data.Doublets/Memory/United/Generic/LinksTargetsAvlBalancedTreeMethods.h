namespace Platform::Data::Doublets::Memory::United::Generic {
  ...
  struct LinksTargetsAvlBalancedTreeMethods : public LinksAvlBalancedTreeMethodsBase<LinksTargetsAvlBalancedTreeMethods<TLinksOptions>, TLinksOptions> {
   ...
   public:
    LinkAddressType GetSize(LinkAddressType node) { return this->GetSizeValue(this->GetLinkReference(node).SizeAsTarget); }

   public:
    void SetSize(LinkAddressType node, LinkAddressType size) { this->SetSizeValue(&this->GetLinkReference(node).SizeAsTarget, size); }

   public:
    bool GetLeftIsChild(LinkAddressType node) { return this->GetLeftIsChildValue(this->GetLinkReference(node).SizeAsTarget); }

   public:
    void SetLeftIsChild(LinkAddressType node, bool value) { this->SetLeftIsChildValue(&this->GetLinkReference(node).SizeAsTarget, value); }

   public:
    bool GetRightIsChild(LinkAddressType node) { return this->GetRightIsChildValue(this->GetLinkReference(node).SizeAsTarget); }

   public:
    void SetRightIsChild(LinkAddressType node, bool value) { this->SetRightIsChildValue(&this->GetLinkReference(node).SizeAsTarget, value); }

   public:
    int8_t GetBalance(LinkAddressType node) { return this->GetBalanceValue(this->GetLinkReference(node).SizeAsTarget); }

   public:
    void SetBalance(LinkAddressType node, int8_t value) { this->SetBalanceValue(&this->GetLinkReference(node).SizeAsTarget, value); }
   ...
   public:
    bool FirstIsToTheLeftOfSecond(LinkAddressType firstSource, LinkAddressType firstTarget, LinkAddressType secondSource, LinkAddressType secondTarget) { return (firstTarget < secondTarget) || (firstTarget == secondTarget && firstSource < secondSource); }

   public:
    bool FirstIsToTheRightOfSecond(LinkAddressType firstSource, LinkAddressType firstTarget, LinkAddressType secondSource, LinkAddressType secondTarget) { return (firstTarget > secondTarget) || (firstTarget == secondTarget && firstSource > secondSource); }
