namespace Platform::Data::Doublets::Memory::United::Generic {
  ...
  class UnusedLinksListMethods : public Platform::Collections::Methods::Lists::AbsoluteCircularDoublyLinkedListMethods<UnusedLinksListMethods<TLinksOptions>, typename TLinksOptions::LinkAddressType>, public ILinksListMethods<typename TLinksOptions::LinkAddressType> {
