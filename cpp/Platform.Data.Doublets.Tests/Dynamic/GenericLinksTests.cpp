namespace Platform::Data::Doublets::Tests::Dynamic::GenericLinksTests {
  ...
  static void UsingStorageWithExternalReferencesWithSizeBalancedTrees(auto &&action) {
    ...
    using StorageType = UnitedMemoryLinks<LinksOptionsType, HeapResizableDirectMemory, LinksSourcesSizeBalancedTreeMethods<LinksOptionsType>, LinksTargetsSizeBalancedTreeMethods<LinksOptionsType>, UnusedLinksListMethods<LinksOptionsType>, Platform::Data::ILinks<LinksOptionsType>>;
  ...
  static void UsingStorageWithExternalReferencesWithRecursionlessSizeBalancedTrees(auto &&action) {
    ...
    using namespace Platform::Data::Doublets::Memory::United::Generic;
    using LinksOptionsType = LinksOptions<TLinkAddress>;
    using StorageType = UnitedMemoryLinks<LinksOptionsType, HeapResizableDirectMemory, LinksSourcesRecursionlessSizeBalancedTreeMethods<LinksOptionsType>, LinksTargetsRecursionlessSizeBalancedTreeMethods<LinksOptionsType>, UnusedLinksListMethods<LinksOptionsType>, Platform::Data::ILinks<LinksOptionsType>>;
    StorageType storage{HeapResizableDirectMemory{}};
    UsingStorage<StorageType>(action);
  }
  ...
  static void UsingStorageWithExternalReferencesWithAvlTrees(auto &&action) {
    ...
    using namespace Platform::Data::Doublets::Memory::United::Generic;
    using LinksOptionsType = LinksOptions<TLinkAddress>;
    using StorageType = UnitedMemoryLinks<LinksOptionsType, HeapResizableDirectMemory, LinksSourcesAvlBalancedTreeMethods<LinksOptionsType>, LinksTargetsAvlBalancedTreeMethods<LinksOptionsType>, UnusedLinksListMethods<LinksOptionsType>, Platform::Data::ILinks<LinksOptionsType>>;
    StorageType storage{HeapResizableDirectMemory{}};
    UsingStorage<StorageType>(action);
  }
  ...
  TEST(DynamicGenericLinksTests, RawNumbersCrudTestWithAvlTrees) {
    UsingStorageWithExternalReferencesWithAvlTrees<std::uint8_t>([](auto &&storage) { TestRawNumbersCrudOperations(storage); });
    UsingStorageWithExternalReferencesWithAvlTrees<std::uint16_t>([](auto &&storage) { TestRawNumbersCrudOperations(storage); });
    UsingStorageWithExternalReferencesWithAvlTrees<std::uint32_t>([](auto &&storage) { TestRawNumbersCrudOperations(storage); });
    UsingStorageWithExternalReferencesWithAvlTrees<std::uint64_t>([](auto &&storage) { TestRawNumbersCrudOperations(storage); });
  }
