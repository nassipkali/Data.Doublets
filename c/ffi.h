...
uint8_t ByteUnitedMemoryLinks_Update(void* this_, const uint8_t* query, uintptr_t len_q, const uint8_t* replacement, uintptr_t len_r, CUDCallback_u8 callback);

uint16_t UInt16UnitedMemoryLinks_Update(void* this_, const uint16_t* query, uintptr_t len_q, const uint16_t* replacement, uintptr_t len_r, CUDCallback_u16 callback);

uint32_t UInt32UnitedMemoryLinks_Update(void* this_, const uint32_t* query, uintptr_t len_q, const uint32_t* replacement, uintptr_t len_r, CUDCallback_u32 callback);

uint64_t UInt64UnitedMemoryLinks_Update(void* this_, const uint64_t* query, uintptr_t len_q, const uint64_t* replacement, uintptr_t len_r, CUDCallback_u64 callback);
